...
七個各自獨立的 mod：HUD 數值化、房主規則、經濟、釣魚生態、收音機自訂音樂、
遊戲內設定頁面，以及一個指令工具視窗。**介面中英雙語**，跟著遊戲語系自動切換。

Seven standalone BepInEx mods for *How to Fish*: HUD numbers, host rules, economy,
fishing ecology, custom radio music, an in-game settings page, and a command tool
window. **The UI is bilingual (繁體中文 / English)** and follows the game's own
