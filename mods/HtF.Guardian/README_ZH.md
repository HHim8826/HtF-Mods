# HtF Guardian（ServerRpc 驗證層）

[English](https://github.com/HHim8826/HtF-Mods/blob/main/mods/HtF.Guardian/README.md) | 繁體中文
...
再把 `HtF.Guardian.dll` 放進 `BepInEx/plugins/`。

當房主時按 **F11** 開啟監控面板。處置預設是「只記錄」——見下面的〈設定〉。
