    ...
    internal static class Theme
    {
        ...
        internal static void Build(Font font)
        {
            ...
            Badge = new GUIStyle(Skin.label)
            {
                ...
                fixedWidth = 58f,   // 放得下英文的 CAUTION，中文的「注意」置中也還好看
            };
        ...
        internal static Color RiskColor(Risk r)
        {
            switch (r)
            {
                case Risk.Caution: return Caution;
                case Risk.Danger: return Danger;
                default: return Safe;
            }
        }

        internal static string RiskLabel(Risk r)
        {
            switch (r)
            {
                case Risk.Caution: return Loc.P("注意", "CAUTION");
                case Risk.Danger: return Loc.P("危險", "DANGER");
                default: return Loc.P("安全", "SAFE");
            }
        }
